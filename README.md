...
> **Developers:** See [docs/DEVELOPMENT.md](docs/DEVELOPMENT.md) for editable installs, verification, and troubleshooting. AI agents should read [AGENTS.md](AGENTS.md).
